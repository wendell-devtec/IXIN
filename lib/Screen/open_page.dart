...
class OpenPage extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => _ControlOpenPage();
}

class _ControlOpenPage extends State<OpenPage>{
  late FToast fToast;
  String? formatDate;
  ...
  void addData(){
    ...
    const  url = "https://devtecapps.com.br/ixin/addOC.php";
    ...
    http.post(uri!,body: {
      ...
      String msg = "REGISTRO DE ABERTURA CONCLUIDO";
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context , constraints){
      ...
      return  Scaffold(
          appBar: AppBar(
            title: Text("ABERTURA LOJA $storeName", style: const TextStyle(fontFamily: 'SuperCell' , fontSize: 20, fontWeight: FontWeight.bold),),
            centerTitle: true,
                      ...
                      children: [
                        Padding(padding: const EdgeInsets.only(left: 5),
                          child: Row(
                            children: [
                              const Center(
                                child: Text("AS LUZES ESTAVAM APAGADAS?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 19)),
                              ),
                              SimpleGroupedChips<bool>(
                        ...
                        Padding(padding: const EdgeInsets.only( top: 15),
                          child: Row(
                            children: [
                              const Center(
                                child: Text("AR CONDICIONADO ESTAVA DESLIGADO?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 15),
                        ...
                        Padding(padding: const EdgeInsets.only(left: 5, top: 15),
                          child: Row(
                            children: [
                              const Center(
                                child: Text("TELEVISÃO ESTAVAM DESLIGADOS?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 17),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 5, top: 15),
                          child: Row(
                            children: [
                              const Center(
                                child: Text("COMPUTADOR ESTAVA DESLIGADO?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 17),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 5, top: 15),
                          child: Row(
                            children: [
                              const Center(
                                child: Text("CELULAR ESTAVA CARREGADO?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 17),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 0.5, top: 15),
                          child: Row(
                            children: [
                              const Center(
                                child: Text("HOUVE PROBLEMA AO ABRIR A LOJA?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 16),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                      ...
                      child:  SizedBox(
                        ...
                        child: CustomButton(
                          onPressed: () async {
                            ...
                            if(luz == null || ar == null || tv == null || pc == null || cell == null || cx == null){
                      ...
                      children: [
                        Padding(padding: const EdgeInsets.only(left: 5 ,top: 10),
                          child: Row(
                            ...
                            children: [
                              const Center(
                                child: Text("AS LUZES ESTAVAM APAGADAS?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 22)),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                                values: const [true , false],
                        ...
                        Padding(padding: const EdgeInsets.only( top: 20),
                          child: Row(
                            ...
                            children: [
                              const Center(
                                child: Text("AR CONDICIONADO ESTAVA DESLIGADO?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 22),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 5, top: 20),
                          child: Row(
                            ...
                            children: [
                              const Center(
                                child: Text("TELEVISÃO ESTAVAM DESLIGADOS?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 22),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 5, top: 20),
                          child: Row(
                            ...
                            children: [
                              const Center(
                                child: Text("COMPUTADOR ESTAVA DESLIGADO?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 22),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 5, top: 20),
                          child: Row(
                            ...
                            children: [
                              const Center(
                                child: Text("CELULAR ESTAVA CARREGADO?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 22),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
                        ...
                        Padding(padding: const EdgeInsets.only(left: 0.5, top: 20),
                          child: Row(
                            ...
                            children: [
                              const Center(
                                child: Text("HOUVE PROBLEMA AO ABRIR A LOJA?",style: TextStyle(color: Colors.white , fontWeight: FontWeight.bold , fontSize: 22),
                                  overflow: TextOverflow.fade,),
                              ),
                              SimpleGroupedChips<bool>(
                                controller: controller,
